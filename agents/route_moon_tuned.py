...
#
# Nothing else. Both are single constants; no logic is altered.
#
# WHY. `_preempt_shift` infers, per premium item, how many steps ahead the
...
#     both of the above                  14/16 +185   <- shipped
#
