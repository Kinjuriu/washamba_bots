...
# Throwaway (FACTS.md facts 15/17 rewritten S4): season ceiling is 14.
# Hold 6 through d10; after second land / carpet, prefix toward 14 and
# stop. Day-0 beach-head is still 4 via calendar_owned_target — not this
# number.
MAX_ANIMALS = 14
...
def calendar_owned_target(day):
    ...
    Rewritten S4 (facts 15/17): beach-head 4; +1 cow day 3; +1 cow day 5
    (4C2S = 6) held through day 10 so the d10 MELON wave and second land
    keep the cash drawer. After d10, prefix toward 14 and stop. Not the
    tape 8/10/12/13/14 (EOD d6 is $177). Not "buy whenever cash allows."
    Not the old d11+ shop-mix count ramp to 18.
    """
    if day < 3:
        return 4
    if day < 5:
...
def decide_animal_market_actions(
    ...
    melon + second land, prefix toward 14 and stop (rewritten S4).
    ...
    if slots > 0 and day == 0:
        ...
        if 3 <= day < 11:
            ...
            # Rewritten S4: after SW window opens, prefix toward 14.
