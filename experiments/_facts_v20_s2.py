...
def leftover_occupant(farm, day, x, y, board_size):
    ...
    First extra (NE) during MELON's window: MELON (S3 will stop post-d0
    refill). Later extras (SW): STRAW d7–12, CARROT d21–25. Home NW is
    not a window occupant here; fact 36 MELON-claims home while opening
    seed is held, else underfoot WHEAT from d0.
    """
    q = tile_quadrant(x, y, board_size)
    if q in later_extra_quadrants_effective(farm, day):
