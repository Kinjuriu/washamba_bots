...
def decide_animal_market_actions(
    ...
    5th; d3/d5 +1 cow each (prefix 4C2S through day 6); d7+ shop mix
    toward the day's intermediate / season target (not a quiet d7, not a
    one-morning season dump). Post-sell cash (fact 11). Wheat reserve
