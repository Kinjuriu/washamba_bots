"""HORIZON S4 pace snapshot: 12 after carpet, 14 from d13, vs route_v20.

Hold 6 through d10; not dump-8 on d11.

Usage:
    .venv/Scripts/python.exe experiments/_trace_horizon_s4.py
    .venv/Scripts/python.exe experiments/_trace_horizon_s4.py 0 8
"""
...
S4 = str(ROOT / "experiments" / "_facts_v20_s4_pace.py")
...
LAND2_COST = 2000
LAND_FLOOR = 500
# Rewritten S4 pace: 12 after carpet, 14 from d13, stop. Hold-6 through d10.
TARGET_HERD = 14
...
def main():
    ...
    for seed in seeds:
        print(f"running S4 seed {seed}...", flush=True)
        print_seed(run_seed(seed, agent=S4))
